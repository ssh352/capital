...
CREATE TABLE `order_info` (
  ...
  `order_submit_status_type` varchar(20) DEFAULT NULL COMMENT '报单提交状态 1 撤单已经被接受,2撤单已经被拒绝, 3撤单已经提交, 4 订单已经被接受,5 订单已经被拒绝 6订单已经提交',
  `order_xtp_id` varchar(50) DEFAULT NULL COMMENT 'XTP系统订单ID',
  `position_effect_type` varchar(30) DEFAULT NULL COMMENT '开平标志 1平,2平今,3平昨,4强平,5强减,6初始值或未知值开平标识，现货适用,7,本地强平,8开,9未知的开平标识类型',
  `price` DECIMAL(10,2) DEFAULT NULL COMMENT '价格',
  `price_type` varchar(20) DEFAULT NULL COMMENT '价格类型 1全部成交或撤销,市价单-深, 2即时成交剩余转撤销，市价单-深,3最优5档即时成交剩余转撤销，市价单-沪深,4最优五档即时成交剩余转限价，市价单-沪,
  ...
  `side_type` varchar(20) DEFAULT NULL COMMENT '买卖方向类型 1 买（新股申购、ETF买等）,2买平.3买开,4合并,5 申购,6 赎回 7卖（逆回购）,8卖平,9卖开 ,10拆分 ,11未知或者无效买卖方向',
